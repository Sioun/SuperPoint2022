...
class SyntheticColon1(Coco):
    ...
    def __init__(
        ...
        **config,
        ...
        self.scenes = [
            ...
            (Path(self.root / folder[:-1]), Path(self.root / folder[:-1])) \
    ...
    def crawl_folders(self, sequence_length):
        ...
        for (scene, scene_img_folder) in self.scenes:
            ...
            for image_pathi in scene_img_folder.iterdir():
                ...
                if 'FrameBuffer' in str(image_pathi):
                    image_paths.append(image_pathi)
            # print('----- img path',image_paths)
            names = [p.stem for p in image_paths]
            # print('currnt names', names)
            imgs = [str(p) for p in image_paths]
            # print('currnt imgs',imgs)
            ...
            for i in range(0, len(imgs) - demi_length):
                ...
                if sample is not None:
                    ...
                    for j in range(1, demi_length + 1):
                        ...
                        print('currnt sample image', imgs[i + j])
        ...
        logging.info("Finished crawl_folders for SyntheticColon1.")
